...
const myFirstArray = ["cat", 1, 10, "dog", true];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = [1, 3, 56, 34, 65, 53, "cat", 3, "dog", 1, 24, false];
...
const myInfo = ["Дарья", 7, "июня", "близнецы"];
...
countries.unshift(firstCountry);
...
const moreCities = ["Санкт-Петербург", "Москва", "Екатеринбург"];
...
function sortAndPrint(randomNumbers) {
  ...
  randomNumbersCopy.sort(function (a, b) {
    return a - b;
  });
